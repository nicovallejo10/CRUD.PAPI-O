...
window.onload = productNameInput.value = '';
...
function showProductName() {
    ...
    // Asigna el nombre del producto según el código de barras seleccionado
    switch (barcode) {
        case '1':
        ...
        case '10':
            ...
            break;
        default:
            productNameInput.value = ''; // Valor por defecto si no hay coincidencia
            break;
    }
}